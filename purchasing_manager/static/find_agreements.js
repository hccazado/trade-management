        ...
        if(e.code == "Enter"){
            ...
            var result = axios.get(url).then(result=>{
                ...
                for (item of agreements){
                    ...
                    date_6.innerHTML = `<a href='/warehouse/edit/${item.id}'><img class='edit' src='/static/edit.png'></a>`
                                        +`<a href='/warehouse/print/${item.id}'><img class='edit' src='/static/print.png'></a>`;
